...
const LandingPage = () => {
    return (
        <div className="min-h-screen mt-12  bg-gray-200 text-gray-900">
...
const features = [
    // { icon: FaUserFriends, title: 'Social Interaction', description: 'Connect with like-minded people nearby.' },
    ...
    // { icon: FaBirthdayCake, title: 'Organizing Parties', description: 'Celebrate with events and parties for the elderly.' },
